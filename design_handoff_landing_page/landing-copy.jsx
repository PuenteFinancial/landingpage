// landing-copy.jsx — bilingual content for the Puente waitlist landing.
// COPY[lang] feeds every section. EN + ES. No fabricated metrics or
// reward specifics — this is a validation page.
...
const COPY = {
  en: {
    ...
    wl: {
      ...
      f: { name: "Full name", phone: "Phone number", email: "Email",
        country: "Country you send to", amount: "How much do you send each month?",
        provider: "Current remittance provider" },
  ...
  es: {
    ...
    wl: {
      ...
      f: { name: "Nombre completo", phone: "Teléfono", email: "Correo electrónico",
        country: "País al que envías", amount: "¿Cuánto envías cada mes?",
        provider: "Proveedor de remesas actual" },
